...
private:
    ...
    static void framebufferResizedCallback(GLFWwindow* window, int witdh, int height)
    {
        auto ptr = reinterpret_cast<HelloTriangleApplication*>(glfwGetWindowUserPointer(window));
    ...
    void createInstance()
    {
        ...
        appInfo.pEngineName = "Siema Eniu";
    ...
    void createImageViews()
    {
        ...
        for (size_t i = 0; i < swapChainImages.size(); i++)
        {
            swapChainImageViews.at(i) = createImageView(swapChainImages.at(i), swapChainImageFormat);
        }
    }
    ...
    void createTextureImage()
    {
        ...
        stbi_uc* pixels = stbi_load("assets/images/image.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
    ...
    void createTextureSampler()
    {
        ...
        {
            throw std::runtime_error("failed to create texutre sampler!");
        }
    }
    ...
    void createUniformBuffers()
    {
        ...
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++)
        {
            createBuffer(bufferSize, VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, uniformBuffers.at(i), uniformBuffersMemory.at(i));
    ...
    void createDescriptorSets()
    {
        ...
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++)
        {
           ...
           std::array<VkWriteDescriptorSet, 2> descriptorWrites{};
               ...
               descriptorWrites.at(0).dstSet = descriptorSets.at(i);
               ...
               descriptorWrites.at(0).pImageInfo = nullptr;
               descriptorWrites.at(0).pTexelBufferView = nullptr;
    ...
    void drawFrame()
    {
        ...
        // Czekamy na renderFinished semafor powi¹zany z obrazem
